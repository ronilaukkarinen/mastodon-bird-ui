...
1. Copy the contents of `style.min.css` (recommended since it is optimized and smaller) or `style.css`
...
2. Get the `style.min.css` from this repo (assuming you just want to apply the style, if you want to edit it to suit your needs you can use `style.css` which includes prettified code and explanations)
